...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Liste des machines paginée' }),
...
], MachinesController.prototype, "getListe", null);
__decorate([
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Détail d\'une machine' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __param(1, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String]),
    __metadata("design:returntype", void 0)
], MachinesController.prototype, "getUne", null);
__decorate([
    (0, common_1.Post)(),
    (0, roles_decorator_1.Roles)(shared_1.UserRole.ADMIN, shared_1.UserRole.PRODUCTION),
    (0, audit_decorator_1.Audit)({ action: 'CREATE', entite: 'Machine' }),
    (0, swagger_1.ApiOperation)({ summary: 'Ajouter une machine' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, create_machine_dto_1.CreateMachineDto]),
    __metadata("design:returntype", void 0)
], MachinesController.prototype, "creer", null);
__decorate([
    (0, common_1.Put)(':id'),
    (0, roles_decorator_1.Roles)(shared_1.UserRole.ADMIN, shared_1.UserRole.PRODUCTION),
    (0, audit_decorator_1.Audit)({ action: 'UPDATE', entite: 'Machine' }),
    (0, swagger_1.ApiOperation)({ summary: 'Modifier une machine' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __param(1, (0, common_1.Param)('id')),
    ...
    __metadata("design:returntype", void 0)
], MachinesController.prototype, "modifier", null);
__decorate([
    (0, common_1.Patch)(':id/statut'),
    (0, roles_decorator_1.Roles)(shared_1.UserRole.ADMIN, shared_1.UserRole.PRODUCTION),
    (0, audit_decorator_1.Audit)({ action: 'STATUT', entite: 'Machine' }),
    (0, swagger_1.ApiOperation)({ summary: "Changer le statut d'une machine (disponible/maintenance/en_panne)" }),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __param(1, (0, common_1.Param)('id')),
    ...
    __metadata("design:returntype", void 0)
], MachinesController.prototype, "changerStatut", null);
__decorate([
    (0, common_1.Delete)(':id'),
    (0, roles_decorator_1.Roles)(shared_1.UserRole.ADMIN),
    (0, audit_decorator_1.Audit)({ action: 'DELETE', entite: 'Machine' }),
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, swagger_1.ApiOperation)({ summary: 'Archiver une machine (soft delete)' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __param(1, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String]),
    __metadata("design:returntype", void 0)
], MachinesController.prototype, "supprimer", null);
exports.MachinesController = MachinesController = __decorate([
    ...
    (0, module_required_decorator_1.ModuleRequired)('machines'),
