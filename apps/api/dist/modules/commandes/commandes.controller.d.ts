...
export declare class CommandesController {
    private commandesService;
    constructor(commandesService: CommandesService);
    getCommandes(user: JwtPayload, page?: number, limite?: number, statut?: string, clientId?: string): Promise<{
        items: ({
            client: {
                id: string;
                nom: string;
    ...
    getCommande(user: JwtPayload, id: string): Promise<{
        client: {
            id: string;
            tenantId: string;
            createdAt: Date;
    ...
    creerCommande(user: JwtPayload, dto: CreateCommandeDto): Promise<{
        client: {
            nom: string;
        };
        lignes: ({
    ...
    supprimerCommande(user: JwtPayload, id: string): Promise<{
        message: string;
    }>;
}
